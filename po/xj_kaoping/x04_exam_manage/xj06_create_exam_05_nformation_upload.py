...
class Xj06CreateExam05InformationUpload(object):
    ...
    cancel = (By.XPATH, '//span[contains(text(),"取消")]')
    ...
    def upload_invigilation(self):
        ...
        win_upload(r'J:\now_job\西交智慧\基础数据\成都七中\成都七中_东区总校_cwz_监考老师.xlsx')
        self.web.wait(3)
    ...
    def upload_marking(self):
        ...
        self.web.click(*self.invigilation_file_upload)
        win_upload(r'J:\now_job\西交智慧\基础数据\成都七中\成都七中_东区总校_cwz_阅卷老师.xlsx')
        self.web.wait(3)
        self.web.exec_js(self.enter_js)
        self.web.exec_js(self.alert_js)
        self.web.click(*self.cancel)
    ...
    def upload_inspector(self):
        ...
        self.web.click(*self.invigilation_file_upload)
        win_upload(r'J:\now_job\西交智慧\基础数据\成都七中\成都七中_东区总校_cwz_巡考老师.xlsx')
        self.web.wait(3)
        self.web.exec_js(self.enter_js)
        self.web.exec_js(self.alert_js)
        self.web.click(*self.cancel)
